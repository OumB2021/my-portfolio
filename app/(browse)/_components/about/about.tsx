    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-14 lg:px-6">
        ...
        <p className="mt-4 text-sm md:text-base text-center leading-relaxed text-stone-400 max-w-4xl mx-auto">
          ...
          class and immediately fell in love with the world of{" "}
          <strong className="text-[#f4f4f5]">Web Development. </strong>This
          newfound passion led me to switch my focus to computer science, where
          I could blend my artistic skills with programming to build dynamic,
          user-centric web applications. Now, as I approach graduation, I'm
          excited to contribute to projects that bridge design and
